...
"[project]/app/reports/calls/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function fmt(n) {
    const num = typeof n === 'number' ? n : Number(String(n !== null && n !== void 0 ? n : '').replace(/[^0-9.\-]/g, ''));
...
function formatNoteLine(line) {
    ...
    const [, , mm, dd, text] = m;
    return "".concat(text.trim(), " — ").concat(mm, "/").concat(dd);
}
...
function CallReportPage() {
    ...
    const selectedRow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CallReportPage.useMemo[selectedRow]": ()=>rows.find({
                "CallReportPage.useMemo[selectedRow]": (r)=>r.tag === selectedTag
            }["CallReportPage.useMemo[selectedRow]"])
    }["CallReportPage.useMemo[selectedRow]"], [
        rows,
        selectedTag
    ]);
    ...
    const load = async ()=>{
        ...
        setErr(null);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["searchJobs"])('@report'); // Finished / Caped / Delivered
            ...
            setErr((e === null || e === void 0 ? void 0 : e.message) || 'Failed to load report');
            setRows([]);
            setSelectedTag(null);
        } finally{
            setLoading(false);
    ...
    const displayPrice = (j)=>{
        var _price, _ref;
        const got = (_ref = (_price = j.price) !== null && _price !== void 0 ? _price : j.Price) !== null && _ref !== void 0 ? _ref : undefined;
    ...
    const refreshOne = async (tag)=>{
        try {
            const r = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getJob"])(tag);
            if ((r === null || r === void 0 ? void 0 : r.exists) && r.job) {
    ...
    /* actions */ const onMarkCalled = async ()=>{
        ...
        try {
            setSaving(true);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["markCalled"])({
                tag,
                scope: 'auto',
                notes: note
            });
            if (note) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logCallSimple"])({
                    tag,
            ...
            alert((e === null || e === void 0 ? void 0 : e.message) || 'Failed to mark as called.');
        } finally{
            setSaving(false);
        }
    };
    const onPlusAttempt = async ()=>{
        ...
        try {
            ...
            alert((e === null || e === void 0 ? void 0 : e.message) || 'Failed to add attempt.');
        } finally{
            setSaving(false);
        }
    };
    ...
    const onSaveNote = async ()=>{
        ...
        const line = "".concat(note, " — ").concat(mm, "/").concat(dd);
        const existing = selectedRow.callNotes || '';
        const nextNotes = existing ? "".concat(existing, "\n").concat(line) : line;
        try {
            setSaving(true);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveJob"])({
                tag,
                callNotes: nextNotes
            });
            await refreshOne(tag);
            ...
            alert((e === null || e === void 0 ? void 0 : e.message) || 'Failed to save note.');
        } finally{
            setSaving(false);
        }
    };
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                className: "jsx-931cbd3549c6f24f",
                                children: [
                                    (!rows || rows.length === 0) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        className: "jsx-931cbd3549c6f24f",
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: shown ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            isLong && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                children: expanded[r.tag] ? 'Show less' : "Show all (".concat(lines.length, ")")
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/reports/calls/page.tsx",
                                                                lineNumber: 285,
                                                                columnNumber: 29
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    disabled: !selectedRow || saving || !(notes[selectedRow === null || selectedRow === void 0 ? void 0 : selectedRow.tag] || '').trim(),
                                    onClick: onSaveNote,
...
_s(CallReportPage, "lbA6XSm/rzc3p3DD2U1ESApXGAw=");
_c = CallReportPage;
var _c;
__turbopack_context__.k.register(_c, "CallReportPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_bdf83b07._.js.map