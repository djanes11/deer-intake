...
;
function baseUrl() {
    const b = ("TURBOPACK compile-time value", "https://script.google.com/macros/s/AKfycbwj4EMKrKtEJmkqCv-wk-ctzcDmkoyp1Ocsg8wFx4kNMTWLTib3LOrEb0shrEB27l6N-A/exec") || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GAS_BASE;
...
async function passThrough(req) {
    var _process_env_GAS_TOKEN;
    const GAS = baseUrl();
    const token = ((_process_env_GAS_TOKEN = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GAS_TOKEN) === null || _process_env_GAS_TOKEN === void 0 ? void 0 : _process_env_GAS_TOKEN.trim()) || '';
    if (req.method === 'GET') {
        // forward all query params
        const out = withTokenURL("".concat(GAS, "?").concat(req.nextUrl.searchParams.toString()), token);
        const res = await fetch(out, {
            method: 'GET',
            cache: 'no-store'
        });
        const txt = await res.text();
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NextResponse"](txt, {
            status: res.status,
            headers: {
...
function CallReportPage() {
    ...
    const onMarkCalled = async (row)=>{
        ...
        try {
            ...
            if (note) await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logCallSimple"])({
                tag,
    ...
    /** Optimistic +1 Attempt -> persist via GAS (log-call) -> refresh row */ const onPlusAttempt = async (row)=>{
        ...
        setRows((prev)=>prev.map((x)=>x.tag === tag ? {
                    ...
                    callNotes: note ? x.callNotes ? "".concat(x.callNotes, "\n").concat(note) : note : x.callNotes
                } : x));
        try {
            var _this;
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logCallSimple"])({
                tag,
                reason: reasonForRow(row),
                notes: note
            });
            if (!((_this = res) === null || _this === void 0 ? void 0 : _this.ok)) throw new Error('Server declined.');
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        r.callNotes ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            style: {
                                                                whiteSpace: 'pre-wrap',
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "85d5ecdb45ef1ca6",
                children: ".table.jsx-85d5ecdb45ef1ca6 tr.jsx-85d5ecdb45ef1ca6:hover td.jsx-85d5ecdb45ef1ca6{background:var(--bg-elev-2,rgba(0,0,0,.06))}"
...
_s(CallReportPage, "vZOFhYJpYyAXJaQpnG2MwfWow/8=");
_c = CallReportPage;
var _c;
...
//# sourceMappingURL=_dfbc02b7._.js.map