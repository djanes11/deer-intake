...
async function fetchJSON(input, init) {
    ...
    if (!res.ok) {
        const msg = data && (data.error || data.message) || "HTTP ".concat(res.status);
        throw new Error(msg);
    }
    return data;
}
...
async function logCallSimple(payload) {
    // Apps Script expects action 'log-call'
    return fetchJSON(PROXY, {
        method: 'POST',
        body: JSON.stringify({
            action: 'log-call',
...
;
;
// ---------- small helpers (no template strings) ----------
function normProc(s) {
...
function specialtyPriceFromRow(j) {
    ...
    const jerky = toInt(j.slicedJerkyLbs);
    return ss * 4.25 + ssc * 4.60 + jerky * 15.0;
}
function fmtMoney(n) {
...
function CallReportPage() {
    ...
    // Flips appropriate status to "Called" and (optionally) logs note
    async function onMarkCalled(row) {
        const tag = row.tag;
    ...
    // Increments attempts + appends notes (no status change)
    async function onPlusAttempt(row) {
        const tag = row.tag;
        const note = (notes[tag] || '').trim();
        // optimistic
        setRows((prev)=>prev.map((r)=>r.tag === tag ? {
                    ...
                    callNotes: note ? (r.callNotes ? r.callNotes + '\n' : '') + note : r.callNotes
                } : r));
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logCallSimple"])({
                tag,
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                            ...
                                                            placeholder: "e.g., Pickup Fri 4–6pm",
                                                            style: {
                                                                width: '100%',
                                                                padding: '10px 12px',
                                                                borderRadius: 10,
...
//# sourceMappingURL=_b3edaa93._.js.map