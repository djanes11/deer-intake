module.exports = [
"[project]/.next-internal/server/app/api/gas2/save/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/gas2/save/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const res = await fetch(GAS_BASE + '?action=save', {
        ...
        cache: 'no-store',
        // 👇 include action in the body as well
        body: JSON.stringify({
            action: 'save',
            job
        })
    ...
    r.headers.set('X-Route', 'save-v2');
    return r;
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__e448133b._.js.map