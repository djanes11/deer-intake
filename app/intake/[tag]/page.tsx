...
export default async function Page({
  ...
  try {
    ...
    if (!verifyToken(tagDec, t)) {
      return (
        <div style={{maxWidth:760, margin:'24px auto', padding:'16px'}}>
          <h1 style={{color:'#0b0f12', margin:'0 0 8px'}}>Access denied</h1>
    ...
    return (
      <div style={{maxWidth:1040, margin:'18px auto', padding:'0 14px 40px'}}>
        <div style={{maxWidth:980, margin:'16px auto', padding:14, background:'#fff'}}>
          <h2 style={{margin:'6px 0 10px'}}>Deer Intake (Read-only)</h2>

          {/* Summary */}
          <div style={{position:'relative', background:'#f8fafc', border:'1px solid #e6e9ec', borderRadius:10, padding:8, marginBottom:10}}>
            <div style={{display:'grid', gap:8, gridTemplateColumns:'repeat(3, 1fr)'}}>
              <div>
                <label>Tag Number</label>
                <div style={{ background:'#fff', border:'1px solid #cbd5e1', borderRadius:10, padding:'6px 8px' }}>{job?.tag || ''}</div>
                <div style={{fontSize:12, color:'#6b7280'}}>Deer Tag</div>
              </div>
              <div>
                ...
                <div style={{fontSize:12, color:'#6b7280'}}>Proc. type + beef fat + Webbs fee</div>
              </div>
              <div>
                ...
                <div style={{fontSize:12, color:'#6b7280'}}>Sausage/Jerky lbs</div>
              </div>
            </div>
