    ...
    <main className="app-frame" style={{ maxWidth: 1040, color: '#0f172a' }}>
      ...
      <div style={{ display: 'grid', gap: 14 }}>
        ...
        <div style={sectionCard}>
          ...
          <div style={{ fontSize: 13, color: '#334155', lineHeight: 1.55 }}>
            Customize the customer-facing email and text copy for major updates. Available placeholders include {'{{name}}'}, {'{{tag}}'}, {'{{businessName}}'}, {'{{smsBusinessName}}'}, {'{{phoneSuffix}}'}, {'{{statusLine}}'}, {'{{statusUrl}}'}, {'{{pickupHours}}'}, {'{{processingDueLine}}'}, {'{{specialtyDueLine}}'}, {'{{intakeLink}}'}, and {'{{intakeLinkLine}}'}.
          </div>
