    ...
    <main className="light-page watermark" style={{ margin: '0 auto', maxWidth: 960, padding: '18px 14px 40px' }}>
      ...
      <section className="form-card" style={{ padding: 14, borderRadius: 12, marginBottom: 12 }}>
        ...
        <div style={{ display: 'grid', gap: 8, gridTemplateColumns: 'repeat(4, minmax(0,1fr))' }} className="grid">
          ...
          <div className="mini-card" style={{ padding: '10px 12px', borderRadius: 10, background: '#f5f8ff' }}>
            ...
            <div className="muted" style={{ fontSize: 12 }}>Triggers the ready notification</div>
          </div>
          <div className="mini-card" style={{ padding: '10px 12px', borderRadius: 10, background: '#f5f8ff' }}>
        ...
        <p className="muted" style={{ marginTop: 8 }}>
          Caping and any optional partner workflows can have their own sub-statuses; update those when relevant.
        </p>
      </section>
      ...
      <section className="form-card" style={{ padding: 14, borderRadius: 12, marginBottom: 12 }}>
        ...
        <ul style={{ paddingLeft: 18, margin: '6px 0' }}>
          ...
          <li><b>Beef Fat</b> adds a small fee; optional partner workflows or outside services may add separate fees.</li>
          <li><b>Specialty Products</b> only show if selected; make sure to fill in the pounds.</li>
        </ul>
      </section>
      ...
      <section className="form-card" style={{ padding: 14, borderRadius: 12 }}>
        ...
        <ul style={{ paddingLeft: 18, margin: '6px 0' }}>
          ...
          <li><b>Search shows no rows</b>: Try the exact <i>name</i>, <i>tag</i>, or phone last-4.</li>
          <li><b>Ready notification did not send</b>: Verify the status really hit <i>Finished &amp; Ready</i> and that the contact details are present.</li>
        </ul>
      </section>
    </main>
  );
