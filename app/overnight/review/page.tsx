...
// NEW: show the *end* of long strings (…Blackburn, …87174, …2373)
...
export default function OvernightReview() {
  ...
  return (
    <main
      ...
      style={{ maxWidth: 1540, margin: '18px auto', padding: '0 14px 40px' }}
    >
      ...
      <div className="form-card no-print" style={{ padding: 14, color: '#0b0f12' }}>
        ...
        >
          ...
          <button onClick={load} className="btn small">
            Refresh
          </button>
        </div>
        ...
        {loading ? (
          ...
          >
            ...
            {rows.map((r) => (
              ...
              >
                {/* Name: keep tail for phone view / long names */}
                <div style={{ ...cell }}>{tail(r.customer || '', 22)}</div>

                {/* Conf #: keep tail so last digits visible */}
                <div
                  style={{
                    ...cell,
                ...
                >
                  {tail(r.confirmation || '', 14)}
                </div>

                {/* Phone: show tail so last digits stand out */}
                <div style={cell}>{tail(r.phone || '', 16)}</div>
                ...
                <div
                  style={{
                    textAlign: 'center',
                    fontWeight: 800,
                    color: r.webbs ? '#15803d' : '#64748b',
                  }}
                >
                  {r.webbs ? 'Yes' : ''}
                </div>

                {/* Proc $: whole dollars, no symbol */}
                <div
                  style={{
                    textAlign: 'center',
                    fontVariantNumeric: 'tabular-nums' as const,
