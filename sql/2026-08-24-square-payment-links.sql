...
create table if not exists public.square_payment_links (
  ...
  payment_confirmation_channel text null,
  payment_confirmation_email_sent_at timestamptz null,
  payment_confirmation_sms_sent_at timestamptz null,
  payment_confirmation_sms_sid text null,
  payment_confirmation_error text null,
